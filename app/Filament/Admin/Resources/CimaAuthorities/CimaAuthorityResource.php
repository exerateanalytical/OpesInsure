...
namespace App\Filament\Admin\Resources\CimaAuthorities;
...
final class CimaAuthorityResource extends Resource
{
    ...
    protected static ?string $model = RegulatoryAuthority::class;
    ...
    protected static ?string $modelLabel = 'regulatory authority';
    ...
    public static function table(Table $table): Table
    {
        return $table->columns([
            ...
            ->recordActions([static::versionAction(['name_fr', 'name_en'])]);
    }
