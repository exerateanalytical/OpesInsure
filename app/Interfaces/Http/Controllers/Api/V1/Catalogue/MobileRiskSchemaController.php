 ...
 *
 * Question-set schemas (question_sets, seeded from RiskSchemaCatalogue) carry a `version`; a stored line schema older than the
...
{
    public function __construct(private readonly MasterDataFlows $flows, private readonly QuestionSetCatalogue $questions) {}
    ...
    public function __invoke(string $code): JsonResponse
    {
        ...
        // REQ-DUP-020: line default questions come from question_sets (RiskSchemaCatalogue is its seed data).
        $defaults = $this->questions->lineSchema($code) ?? $this->flows->schemaFor($code);
