        ...
        return self::$machine ??= StateMachineDefinition::fromArray([
            ...
            'transitions' => [
                ...
                ['event' => 'make_payable', 'from' => ['APPROVED'], 'to' => 'VESTED', 'guards' => ['commission.vesting_elapsed'],
                    'side_effects' => ['financial_obligation:PAYABLE/COMMISSION'], 'domain_event' => 'commission.payable'],
                ['event' => 'vest', 'from' => ['PENDING'], 'to' => 'VESTED', 'guards' => ['commission.vesting_elapsed'],
                    'side_effects' => ['financial_obligation:PAYABLE/COMMISSION'], 'domain_event' => 'commission.payable'],
                ['event' => 'pay', 'from' => ['VESTED', 'AVAILABLE'], 'to' => 'PAID', 'side_effects' => ['financial_obligation:settle'], 'domain_event' => 'commission.paid'],
