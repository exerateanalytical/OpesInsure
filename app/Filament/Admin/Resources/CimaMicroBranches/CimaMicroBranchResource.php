...
namespace App\Filament\Admin\Resources\CimaMicroBranches;
...
final class CimaMicroBranchResource extends Resource
{
    ...
    protected static ?string $model = MicroinsuranceBranch::class;

    protected static string|BackedEnum|null $navigationIcon = Heroicon::OutlinedSparkles;

    protected static ?string $navigationLabel = 'Microinsurance (Art. 717)';

    protected static ?int $navigationSort = 204;

    protected static ?string $modelLabel = 'microinsurance branch';
    ...
    public static function table(Table $table): Table
    {
        return $table->defaultSort('number')->columns([
                ...
                Tables\Columns\TextColumn::make('label_fr')->label('Libellé (FR)')->searchable(),
                Tables\Columns\TextColumn::make('label_en')->label('Label (EN)')->searchable(),
            ...
            ->filters([Tables\Filters\SelectFilter::make('business_family')->options(['NON_LIFE' => 'Non-life', 'LIFE' => 'Life'])])
