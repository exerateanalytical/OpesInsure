...
{
    use HasUuids;
    protected $fillable = ['partner_id','name','client_id','client_secret_hash','oauth_client_id','scopes','allowed_ips','status','rate_limit_per_minute','environment','certified_at','certified_by','activated_at','revoked_at','revoked_by','revocation_reason','last_used_at'];
