...
final class ClaimReserveChange extends Model{use HasUuids;protected$fillable=['claim_id','previous_amount_minor','requested_amount_minor','currency','status','reason_code','notes','requested_by','approved_by','approved_at'];protected function casts():array{return['approved_at'=>'datetime'];}public function claim():BelongsTo{return$this->belongsTo(Claim::class);}}
