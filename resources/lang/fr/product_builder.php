...
return [
    ...
    'stages' => ['DRAFT' => 'Brouillon', 'CONFIGURATION' => 'Configuration', 'TECHNICAL_REVIEW' => 'Revue technique', 'COMPLIANCE_REVIEW' => 'Revue conformité',
        'BUSINESS_APPROVAL' => 'Approbation métier', 'SANDBOX_TESTS' => 'Tests en bac à sable', 'READY' => 'Prêt', 'PUBLISHED' => 'Publié', 'REJECTED' => 'Rejeté'],
    ...
    'checks' => ['REGULATORY_MAPPING' => 'Rattachement réglementaire', 'CIMA_BRANCH_AUTHORIZED' => 'Agrément de branche CIMA', 'PRICING_MODE' => 'Mode de tarification',
        ...
        'CLAIMS_CONFIGURATION' => 'Configuration sinistres', 'PRODUCT_TESTS' => 'Tests produit', 'CAPABILITY_PROFILE' => 'Profil de capacités', 'DOCUMENT_WARNING' => 'Documents', 'DOCUMENT_ENGINE_WARNING' => 'Moteur documentaire',
