...
return [
    ...
    'nav_demo' => 'Demo accounts',
    'demo_title' => 'Demo accounts — OpesInsure',
    'demo_eyebrow' => 'Evaluation access',
    'demo_heading' => 'Sign in as any role',
    'demo_lede' => 'Every account type on the platform, ready to explore — on the web portal and in the mobile app.',
    'demo_warning_title' => 'These are demonstration accounts on a demonstration environment.',
    'demo_warning_body' => 'The credentials below are public by design. No real customer data, payments or messages exist here — payment and SMS providers are not connected. Do not enter genuine personal or financial information.',
    'demo_web_heading' => 'Web portal',
    'demo_web_sub' => 'Sign in at /admin/login with any email below and the password :password. On the login screen you can also click a role to sign in directly.',
    'demo_mobile_heading' => 'Mobile app',
    'demo_mobile_sub' => 'The app signs in by phone number. Enter one of these numbers, then use the verification code :otp — no SMS is sent in the demo environment.',
    'demo_col_role' => 'Role',
    'demo_col_email' => 'Email',
    'demo_col_phone' => 'Phone number',
    'demo_col_otp' => 'Code',
];
